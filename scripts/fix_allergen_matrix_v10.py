...
#docsAllergens .allergen-table th:nth-child(2)::before{content:'Ce'!important}#docsAllergens .allergen-table th:nth-child(3)::before{content:'Gl'!important}#docsAllergens .allergen-table th:nth-child(4)::before{content:'Cr'!important}#docsAllergens .allergen-table th:nth-child(5)::before{content:'Eg'!important}#docsAllergens .allergen-table th:nth-child(6)::before{content:'Fi'!important}#docsAllergens .allergen-table th:nth-child(7)::before{content:'Lu'!important}#docsAllergens .allergen-table th:nth-child(8)::before{content:'Mi'!important}#docsAllergens .allergen-table th:nth-child(9)::before{content:'Mo'!important}#docsAllergens .allergen-table th:nth-child(10)::before{content:'Mu'!important}#docsAllergens .allergen-table th:nth-child(11)::before{content:'Pe'!important}#docsAllergens .allergen-table th:nth-child(12)::before{content:'Se'!important}#docsAllergens .allergen-table th:nth-child(13)::before{content:'So'!important}#docsAllergens .allergen-table th:nth-child(14)::before{content:'Su'!important}#docsAllergens .allergen-table th:nth-child(15)::before{content:'Nu'!important}
...
@media(max-width:620px){#docsAllergens .allergen-table{min-width:820px!important;width:820px!important}#docsAllergens .allergen-table th:first-child,#docsAllergens .allergen-table td:first-child{width:175px!important;min-width:175px!important}#docsAllergens .allergen-table th:not(:first-child):not(:last-child){width:45px!important;min-width:45px!important}#docsAllergens .allergen-table td:first-child{width:175px!important;min-width:175px!important}}
</style>'''
  ...
  function removeDuplicateAddPizza(){
    ...
    buttons.slice(1).forEach(btn=>{
      ...
      while(node && node!==panel){
        if(node.querySelectorAll('button').length===1){node.remove();break;}
